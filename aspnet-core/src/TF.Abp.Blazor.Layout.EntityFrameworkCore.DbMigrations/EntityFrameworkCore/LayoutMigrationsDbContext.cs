...
namespace TF.Abp.Blazor.Layout.EntityFrameworkCore
{
     ...
     */
    public class LayoutMigrationsDbContext : AbpDbContext<LayoutMigrationsDbContext>
    {
        public LayoutMigrationsDbContext(DbContextOptions<LayoutMigrationsDbContext> options) 
            : base(options)
        {
