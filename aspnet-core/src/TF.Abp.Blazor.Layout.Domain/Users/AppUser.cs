...
namespace TF.Abp.Blazor.Layout.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update LayoutDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update LayoutEfCoreEntityExtensionMappings to extend the IdentityUser entity
